...
public class Bank {
    ...
    public void openAccount(Account account ){ //2
    ...
    public void listAccounts(){ //1
        ...
        try {
            ...
            while (results.next()) {
                System.out.print(results.getString(1) + " " + results.getString(2) + " " + results.getString(3));
                System.out.println();
            }
        } catch (SQLException ex) {
            Logger.getLogger(Bank.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void closeAccount(int number){ //3
        Connection connection = BankingConnection.connect();
    ...
    public void depositMoney(int number, double amount){ //4
    ...
    public void withdrawMoney(int number, double amount){ //5
        Account account = getAccount(number);
    ...
    public Account getAccount(int number){
        Connection connection = BankingConnection.connect(); //6
